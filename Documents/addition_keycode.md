| キーコード | Remap上での表記 | 説明 |
|----|:---:|----|
|JOY_DIGI|JOY_DIGI|ジョイスティック → デジタル4方向|
|JOY_MOUS|JOY_MOUS|ジョイスティック → マウス|
|JOY_ANLG|JOY_ANLG|ジョイスティック → アナログ軸|
|JOY_SPD_UP|JOY_SPD_UP|マウス最大速度 上げる|
|JOY_SPD_DN|JOY_SPD_DN|マウス最大速度 下げる|
